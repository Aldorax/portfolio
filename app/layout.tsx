...
export const metadata: Metadata = {
  title: "Zend Studios | Design & Development Studio",
  description:
    "Build your business with Zend Studios, a design and development studio based in Nigeria.",
  openGraph: {
    images: [
      {
